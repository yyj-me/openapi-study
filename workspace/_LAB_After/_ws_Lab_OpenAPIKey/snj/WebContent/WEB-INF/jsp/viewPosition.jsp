...
function doJob(){
	...
	if(mcode != 'ALL'){
	 	...
	 	$.getJSON("http://satellite.com:8000/satellite/pos/"+mcode, function(data){
		...
		alert("get All models data");
	 	...
	 	$.getJSON("http://satellite.com:8080/satellite/pos/all", function(response){
...
<p>Model Code : <input type="text" id="mcode" value="T1000"></input><a href="javascript:doJob();">FIND</a></p>
<p>
<div id="posdiv"></div>
</p>
