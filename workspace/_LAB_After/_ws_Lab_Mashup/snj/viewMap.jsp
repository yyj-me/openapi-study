...
<script type="text/javascript" src="youtubeutil.js"></script>
...
jQuery(document).ready(
	function () {
		...
		jQuery('#closeYoutube').click(function(){
			...
			jQuery(".layoutYoutube").hide(2000);
		});
...
function loadTerminatorLocations(){
	...
	jQuery.getJSON('http://sattellite.com:8000/satellite/pos/all', function(data){

		jQuery(data.terminatorGeoList).each(function(index){
