...
var url = "http://localhost:8000/satellite/pos/T1";
...
<p><strong>The dragon: </strong>If you don't like the dragon (which was made using a freeware font named "Tattoo"), see <a href="index2.html">this alternate layout</a>. If you want the content and the sidebar to change place, see <a href="index3.html">the reversed version</a>.</p>
