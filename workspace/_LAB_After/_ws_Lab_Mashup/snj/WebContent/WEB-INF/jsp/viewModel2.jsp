...
var apikey = "0T/7CGQjU6cCX6RwbGNkCltp+O4=";

$(document).ready(function() {

	$(document).ajaxError(function(event, request, settings){
		   alert("OAuth Error");
		   self.location="connectTFactory.do";
	});
});
